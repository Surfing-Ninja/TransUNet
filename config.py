...
class Config:
    ...
    eta_min: float = 1e-5
    plateau_start_epoch: int = 3
    plateau_patience_epochs: int = 4
    plateau_min_delta: float = 5e-4
    plateau_lr_boost_factor: float = 2.5
    plateau_lr_boost_cap: float = 3e-3
    plateau_max_escapes: int = 5
    plateau_cooldown_epochs: int = 2
    plateau_reset_optimizer_state: bool = True
    momentum: float = 0.99
